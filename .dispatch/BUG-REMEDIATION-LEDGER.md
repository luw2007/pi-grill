...
| --- | --- | --- | --- | --- | --- |
| B1 | acceptance / `glm_anthropic/glm-5.2` | `../grill-wt/bug-accept-core` | `bug-core-a1-158820e3` | Read-only acceptance of BUG-1, BUG-2, BUG-5, BUG-6 against `grill.ts` and named regression tests. No code or test edits. | `.done/bug-core-a1-158820e3` contains the inspected HEAD SHA. | `F7AD9C62-441F-4434-BE7F-A31007DD80F2` | `π - bug-accept-core` / legacy unmarked | accepted; closed 2026-08-18T08:39:53Z by UUID `F7AD9C62-441F-4434-BE7F-A31007DD80F2` |
| B2 | acceptance / `glm_anthropic/glm-5.2` | `../grill-wt/bug-accept-convergence` | `bug-conv-a1-75706355` | Read-only acceptance of BUG-3, BUG-4, BUG-8 against `grill.ts` and named regression tests. No code or test edits. | `.done/bug-conv-a1-75706355` contains the inspected HEAD SHA. | `3BF6C62F-78CC-4156-9DDB-CC00AC972E98` | `π - bug-accept-convergence` / legacy unmarked | accepted; closed 2026-08-18T08:39:53Z by UUID `3BF6C62F-78CC-4156-9DDB-CC00AC972E98` |
| B3 | host-contract review / `claude_sub2api/claude-sonnet-5` | `../grill-wt/bug-accept-shortcut` | `bug-shortcut-a1-3a4b72b7` | Read-only acceptance of BUG-7: default shortcut must be absent from Pi host registries; documentation and tests must agree. | `.done/bug-shortcut-a1-3a4b72b7` contains the inspected HEAD SHA. | `6BC5E50B-B591-4ECE-82D5-211D59F853F1` | `π - bug-accept-shortcut` / legacy unmarked | accepted by owner registry check; closed 2026-08-18T08:39:53Z by UUID `6BC5E50B-B591-4ECE-82D5-211D59F853F1` |
